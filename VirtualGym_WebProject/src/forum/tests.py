...
class UITestCase(TestCase):
    ...
    def test_FQA(self):
    	try:
    		...
    		answer = self.browser.find_element_by_css_selector("#id_questionDescription")
    		answer.send_keys("reply from test")
    		replyA = self.browser.find_element_by_id("replyA").click()
    	except:
