...
class UITestCase(TestCase):
    ...
    def test_facebook_SignIn(self):
    	try:
        	self.browser.get("http://localhost:8000/signIn/")
        	self.assertIn("http://localhost:8000/signIn/", self.browser.current_url)
        	Google_signIn = self.browser.find_element_by_id('facebookSignIn').click()
        	time.sleep(1)
        	...
        	try:
        		...
        		print("user already sign Up with this account")
    ...
    def test_twitter_SignIn(self):
    	try:
        	self.browser.get("http://localhost:8000/signIn/")
        	self.assertIn("http://localhost:8000/signIn/", self.browser.current_url)
        	Google_signIn = self.browser.find_element_by_id('twitterSignIn').click()
        	time.sleep(1)
